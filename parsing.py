...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, default='Benchmark_Data')#'Benchmark_Data'/ 'QSAR_ACs'
    parser.add_argument('--dataset', type=str, default='CHEMBL2971_Ki')#CHEMBL233_Ki
    parser.add_argument('--threshold', type=float, default=0.90, help='threshold for similarity')
    parser.add_argument('--mode', type=str, default='cross_validation', help='cross_validation or train_test or test or hypertune')
    ...
    parser.add_argument('--use_opt_params', type=bool, default=True) # use optimal parameters
    parser.add_argument('--tune_type', type=str, default='grid_search') # grid_search or hyperopt_search; 
   ...
   # cross validation
    ...
    parser.add_argument('--com_loss_weight', type=float, default=0.02)
    parser.add_argument('--uncom_loss_weight', type=float, default=0.02)
